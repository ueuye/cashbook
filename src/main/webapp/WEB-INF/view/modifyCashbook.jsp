			...
			<div class="shadow">
				<table class="table table-bordered text-center">
					...
					<tr>
						...
						<td class="td03 dis_c">
			                <select name ="category" class="text-center bn">
					...
					<tr>
						<td class="td03">금액</td>
						<td class="td03 dis_c"><input class="text-center bn" type="number" name="price" value="${cashbook.price }"></td>
					</tr>
					<tr>
						<td class="td03">메모</td>
						<td class="td03 dis_c"><input class="text-center bn" type="text" name="memo" value="${cashbook.memo }"></td>
					</tr>
				</table>
			</div>
			<br>
